...
--
-- Host: localhost
-- Generation Time: Jul 04, 2019 at 08:55 AM
...
--
ALTER TABLE `pinjaman_buku`
  ADD CONSTRAINT `pinjaman_buku_ibfk_1` FOREIGN KEY (`id_buku`) REFERENCES `buku` (`id_buku`),
  ADD CONSTRAINT `pinjaman_buku_ibfk_2` FOREIGN KEY (`id_pelanggan`) REFERENCES `pelanggan` (`id_pelanggan`);
COMMIT;
